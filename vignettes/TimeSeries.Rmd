...
In studies, we will often find it useful to construct functions that output the value of some exogenous variable over time. 
This package --- **`ramp.func`** --- has utilities to construct and modify ***composed time series*** functions. Each function is the product of four components: 
