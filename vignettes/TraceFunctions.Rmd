...
The name --- **`ramp.trace`** --- arises because it was originally part of the `ramp` family of software packages. A set of functions to model forcing was originally devised for **`ramp.falciparum`**, which takes a deep dive into facliparum malaria epidemiology. Later, the same functionality was built into **`ramp.xds`**. **`ramp.trace`** was built to avoid maintaining duplicate software libraries. 
