...
Mathematical models describing mosquito-borne pathogen transmission dynamics and control are complex, but they are also naturally modular. 
...
+ These functions are used by `ramp.xds` and `ramp.forcing` to configure forcing in the trivial modules. 
